  ...
  return (
    <div className="some">
      ...
      <div className="total">
        ...
        <GeneralCart
        total={books.reduce((acc,book) =>acc + book.price*book.quantity,0)}
        quantity={books.reduce((acc2,book) =>acc2 + book.quantity,0)}
        />
      
      </div>
      <p><Link to="/about">About Shop</Link></p>
      <p><Link to="/GeneralCart">GeneralCart</Link></p>
